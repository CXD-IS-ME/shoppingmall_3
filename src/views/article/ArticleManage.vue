...
const onDeleteArticle = async (row) => {
  ...
  await artDelService(row.ProductID)
...
<template>
  <page-container title="产品管理">
    <template #extra>
      <el-button type="primary" @click="onAddArticle">添加产品</el-button>
    </template>
    ...
    <el-table :data="articleList" v-loading="loading">
      <el-table-column label="产品标题" prop="ProductName">
        <template #default="{ row }">
          <el-link type="primary" :underline="false">{{ row.ProductName }}</el-link>
        </template>
      </el-table-column>
      <el-table-column label="分类" prop="category.CategoryName"></el-table-column>
